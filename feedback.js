  ...
  init_feedbacks() {
    ...
    this.feedbackDefs['power'] = {
      ...
      callback: (feedback, bank) => {
        var feedbackLabel = this.POWERSELECT_FIELD.choices.find(o => {return o.id==feedback.options.powerDropdown}).label;
    ...
    this.feedbackDefs['mode'] = {
      ...
      callback: (feedback, bank) => {
        var feedbackLabel = this.SOURCEMODE_FIELD.choices.find(o => {return o.id==feedback.options.sourceModeDropdown}).label;
