...
class instance extends instance_skel {
  ...
  SendEmotivaControlCommand(command, value) {
    var self = this;
    var cmdlet = '<emotivaControl>' +
                  '<' + command + ' value="' + value + '" ack="yes" />' +
                  '</emotivaControl>';
  ...
  SendEmotivaSubscribeRequest(parameter) {
    var self = this;
    var cmdlet = '<emotivaSubscription protocol="3.0">' +
                  '<' + parameter + ' />' +
                  '</emotivaSubscription>';
    debug(cmdlet);
    self.SendControlPacket(cmdlet);
  ...
  EmotivaQueryProperty(parameter) {
    var self = this;
    var cmdlet = '<emotivaUpdate protocol="3.0">' +
                  '<' + parameter + ' />' +
                  '</emotivaUpdate>';
    self.SendControlPacket(cmdlet);
  }
